...
# Date: Thu, 12 Apr 2018 10:03:36 GMT
#set_units -time ns
...
create_generated_clock -name {SPI_IMU_IntClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 25 49} [list [get_pins {ClockBlock/dclk_glb_1}]]
create_generated_clock -name {timer_clock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 49 97} [list [get_pins {ClockBlock/dclk_glb_2}]]

set_false_path -from [get_pins {__ONE__/q}]

# Component constraints for C:\Users\MattiaCP\Documents\GITHUB\IMU\Firmware\firmware.cydsn\TopDesign\TopDesign.cysch
# Project: C:\Users\MattiaCP\Documents\GITHUB\IMU\Firmware\firmware.cydsn\firmware.cyprj
# Date: Thu, 12 Apr 2018 10:03:25 GMT
